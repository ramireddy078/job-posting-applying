            ...
            <form>
                <div className='flex flex-col md:flex-row justify-center gap-2'>
                    <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 
                                    focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full outline-none'>
                        <input type="text" name='title' id='title' placeholder='what positions are you looking for'
                    ...
                    <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 
                    focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full outline-none'>
                    ...
                    <button type='submit' className='bg-blue text-white rounded-md px-8 py-2 md:px-5 md:rounded-s-none'>
                        Search
                    </button>
                </div>
            </form>
